...
@Component({
  selector: 'app-listroomsnot',
  templateUrl: './listroomsnot.component.html',
  styleUrls: ['./listroomsnot.component.scss']
})
export class ListroomsnotComponent implements OnInit {
 ...
 getId(id)
 {
  ...
  {
      //  console.log('error');
    this.roomservice.getRoomsFull(page).subscribe(
      response =>
      {
