...
@Component({
  selector: 'app-room-unavailable',
  templateUrl: './room-unavailable.component.html',
  styleUrls: ['./room-unavailable.component.scss']
})
export class RoomUnavailableComponent implements OnInit {
  forma   : FormGroup;
  public rooms: Room[];
  public room: Room;
  public url :String;
